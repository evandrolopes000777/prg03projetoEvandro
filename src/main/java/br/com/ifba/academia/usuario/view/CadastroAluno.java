...
public class CadastroAluno extends javax.swing.JFrame {
   ...
   private Usuario alunoEmEdicao = null;
   
   public CadastroAluno(UsuarioIController usuarioService, PessoaIController pessoaService) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            java.time.LocalDate dataNasc = java.time.LocalDate.parse(dataDigitada, formatter);

            Usuario usuario = (this.alunoEmEdicao != null) ? this.alunoEmEdicao : new Usuario();
            Pessoa pessoa = (usuario.getPessoa() != null) ? usuario.getPessoa() : new Pessoa();
            
            pessoa.setNome(nomeDigitado);
            pessoa.setCpf(cpfDigitado);
            pessoa.setTelefone(telefoneDigitado);
            pessoa.setDataNascimento(dataNasc);
            
            if(pessoa.getId() == null) pessoa = pessoaService.save(pessoa);
            else pessoa = pessoaService.update(pessoa);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Erro: Digite a data no formato DD/MM/AAAA.");
        } catch (Exception e) {
    ...
    public void preencherCamposParaEdicao(Usuario aluno) {
        this.alunoEmEdicao = aluno;
        txtNome.setText(aluno.getPessoa().getNome());
        txtCpf.setText(aluno.getPessoa().getCpf());
        txtTelefone.setText(aluno.getPessoa().getTelefone());
        txtDataNascimento.setText(aluno.getPessoa().getDataNascimento().format(java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy")));
