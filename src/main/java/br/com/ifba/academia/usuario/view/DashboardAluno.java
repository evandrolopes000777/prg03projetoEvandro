...
public class DashboardAluno extends javax.swing.JFrame {
    ...
    public DashboardAluno(Usuario alunoLogado, PlanoAlunoIController planoAlunoService, FichaTreinoIController fichaTreinoService) {
    ...
    private void carregarDadosDoAluno() {
        lblBemVindo.setText("Bem-vindo(a), " + alunoLogado.getPessoa().getNome());

        try {
            List<PlanoAluno> planos = planoAlunoService.findAll();
            PlanoAluno planoAtual = null;
            for(PlanoAluno p : planos) {
                if(p.getAluno().getId().equals(alunoLogado.getPessoa().getId())) {
                    planoAtual = p;
                    break;
                }
            }
