...
public class CadastroPlano extends javax.swing.JFrame {
   ...
   private com.ifba.academia.model.Plano planoEmEdicao = null;

    public CadastroPlano(com.ifba.academia.service.PlanoService planoService) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
       ...
       String nomeDigitado = txtNome.getText();
        ...
        try {
            Integer duracaoConvertida = Integer.parseInt(duracaoDigitada);
            java.math.BigDecimal valorConvertido = new java.math.BigDecimal(valorDigitado.replace(",", "."));
            
            com.ifba.academia.model.Plano plano;
            
            if (this.planoEmEdicao != null) {
                plano = this.planoEmEdicao;
            } else {
                plano = new com.ifba.academia.model.Plano();
            }
            
            plano.setNome(nomeDigitado);
            plano.setDuracaoDias(duracaoConvertida);
            plano.setValor(valorConvertido);
            
            this.planoService.salvar(plano);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Erro de formatação! Certifique-se de digitar apenas números inteiros para a duração e números para o valor (Ex: 150.00).", "Erro", javax.swing.JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
    ...
    public void preencherCamposParaEdicao(com.ifba.academia.model.Plano plano) {
