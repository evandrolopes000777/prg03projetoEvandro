...
public class CadastroExercicio extends javax.swing.JFrame {
   ...
   private com.ifba.academia.model.Exercicio exercicioEmEdicao = null;
   
   public CadastroExercicio(com.ifba.academia.service.ExercicioService exercicioService, com.ifba.academia.service.FichaTreinoService fichaTreinoService) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
       ...
       String nomeDigitado = txtNome.getText().trim();
        ...
        try {
            com.ifba.academia.model.Exercicio exercicio = (this.exercicioEmEdicao != null) ? this.exercicioEmEdicao : new com.ifba.academia.model.Exercicio();
            
            exercicio.setNome(nomeDigitado);
            //Converte os textos para Números
            exercicio.setSeries(Integer.parseInt(seriesDigitado));
            exercicio.setRepeticoes(Integer.parseInt(repeticoesDigitado));
            exercicio.setCarga(Double.parseDouble(cargaDigitada));

            com.ifba.academia.model.FichaTreino ficha = new com.ifba.academia.model.FichaTreino();
            ficha.setId(1L);
            ...
            // Se o usuário digitar letras no lugar de números
            javax.swing.JOptionPane.showMessageDialog(this, "Erro: Séries, Repetições e Carga devem ser apenas números!");
        } catch (Exception e) {
    ...
    public void preencherCamposParaEdicao(com.ifba.academia.model.Exercicio exercicio) {
